module.exports = {
  ...
  GET_steam_resolveVanity: function(vanity) { return 'http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=' + App.credentials.steamApiKey + '&vanityurl=' + vanity }
};